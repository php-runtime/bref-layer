...
use Runtime\BrefLayer\Command\ListCommand;
use Runtime\BrefLayer\Command\PublishCommand;
    ...
    protected function createContainer(): Container
    {
        ...
        $builder->addDefinitions([
            ...
            ListCommand::class => function (ContainerInterface $c) {
                return new ListCommand($c->get(LayerProvider::class), $c->get(BrefRegionProvider::class), $c->get('project_dir'));
            },
            PublishCommand::class => function (ContainerInterface $c) {
                return new PublishCommand($c->get(LayerPublisher::class), $c->get(BrefRegionProvider::class), $c->get('project_dir'));
            },
